...
opts.Add(PathVariable('target_path', 'The path where the lib is installed.', 'concept1/logic/libs/'))
opts.Add(PathVariable('target_name', 'The library name.', 'libConcept1', PathVariable.PathAccept))
...
modules = []
for root, dirnames, filenames in os.walk('native'):
  for dir in dirnames:
